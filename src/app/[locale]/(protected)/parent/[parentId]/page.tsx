          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              {parent.photoUrl ? (
                ...
                <div className="w-20 h-20 bg-olive-100 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            {/* View Story Button */}
            <Link href={`/${locale}/parent/${parentId}/summary`} className="sm:flex-shrink-0">
